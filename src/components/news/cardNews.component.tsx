...
const CardNewsComponent:FC<CardNewsPageComponentProps> = ({news}) => {
    return <motion.article
        ...
        className="bg-gray-900 border border-gray-700 flex flex-col md:flex-row shadow-sm hover:shadow-md transition-shadow duration-300"
    >
        ...
        <span>
          {new Date(news.date).toLocaleDateString('es-ES', {
              ...
              year: 'numeric'
                ...
                <a href="#" className="text-accent-400 hover:text-accent-200 font-medium">
