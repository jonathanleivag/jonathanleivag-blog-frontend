                ...
                <td className="px-6 py-4 text-sm text-gray-900">
                    <div className="flex gap-2">
                        <button
                            ...
                            className="flex items-center gap-1 text-sm text-yellow-600 hover:text-yellow-700 font-medium transition-colors cursor-pointer border border-yellow-400 bg-yellow-50 px-2 py-1 rounded-md hover:bg-yellow-100"
                        >
